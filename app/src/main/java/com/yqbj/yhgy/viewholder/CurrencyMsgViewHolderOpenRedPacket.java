...
public class CurrencyMsgViewHolderOpenRedPacket extends MsgViewHolderBase {
    ...
    public CurrencyMsgViewHolderOpenRedPacket(BaseMultiItemFetchLoadAdapter adapter) {
        super(adapter);
