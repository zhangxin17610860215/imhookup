...
public class MyDynamicsActivity extends BaseActivity {
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, MyDynamicsActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mydynamics_activity_layout);
    ...
    @OnClick(R.id.img_goSend)
    public void onViewClicked() {
        SendDynamicsActivity.start(mActivity);
    }
}
