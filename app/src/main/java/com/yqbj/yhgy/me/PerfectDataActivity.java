...
public class PerfectDataActivity extends BaseActivity {
    ...
    private void initData() {
        ...
        String wxHeadImage = Preferences.getHeadImag();
        String wxName = Preferences.getNikename();
        Glide.with(activity).load(wxHeadImage).error(R.mipmap.default_head_logo).into(imgUpHead);
